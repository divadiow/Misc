...
typedef enum http_request_header {
    ...
    HTTP_REQUEST_HEADER_CLIENT_MAC,
    HTTP_REQUEST_HEADER_DEVICE_ID,
    HTTP_REQUEST_HEADER_DEVICE_NAME,
    HTTP_REQUEST_HEADER_DEVICE_MODEL,
    HTTP_REQUEST_HEADER_WIFI_SSID,
    HTTP_REQUEST_HEADER_WIFI_BSSID,
    HTTP_REQUEST_HEADER_PRIVATE_IPADDR,
    HTTP_REQUEST_HEADER_DEVICE_LOCATION,
    HTTP_REQUEST_HEADER_PLATFORM_NAME,
    HTTP_REQUEST_HEADER_PLATFORM_VERSION,
    HTTP_REQUEST_HEADER_APP_VERSION,
    HTTP_REQUEST_HEADER_MAX
